...
void SliderScrolled(Fl_Widget * pWidget, void * pVoid )
{
	static int a = 0;
	++a;
	char strLabel[12] = "Abhi_";

	pWidget->label(strLabel);

	sprintf(strLabel, "%d", a);
...
void CustomWnd::UpButtonClick( Fl_Widget * pWidget, void * pVoid )
{
	...
	_beginthread( PrintNumbersInThreadUp, 0, pWnd);
...
CustomWnd::CustomWnd():Fl_Window(500,500)
{
	...
	m_pSLider = new Fl_Slider(200,20,20,100,"");

	//m_pSLider->label("Abhi_Slider");
	...
	m_pSLider->callback(SliderScrolled,this);
